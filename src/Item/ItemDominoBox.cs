...
{
    class ItemDominoBox : ItemWithAttributesTemplate
    {
        public string woodTexPrefix;

        public override string MeshRefName => "tableTopGames_ItemDominoBox_Meshrefs";
                ...
                case 0:
                    {
                        ...
                        var boardStack = slot.Itemstack.Attributes.GetItemstack("dominobox");
        ...
        public override void GetHeldItemInfo(ItemSlot inSlot, StringBuilder dsc, IWorldAccessor world, bool withDebugInfo)
        {
            ...
            var board = inSlot.Itemstack.Attributes.GetItemstack("dominobox");
